<section class="p-service c-bg--gray" id="service">
  ...
  <div class="c-wrap">
    ...
    <section class="p-service__content">
      ...
      <div class="p-service__content__gallery">
    ...
    </section><!-- p-service__content(デザイン) -->
    ...
    <section class="p-service__content">
      ...
      <div class="p-service__content__gallery">
        ...
        <section class="p-serviceCard c-fadeIn js-fadeIn">
          ...
          <h4>フロントエンドコーディング</h4>
          <p class="p-serviceCard__caption">HTML、CSS、JavaScriptを使用して、デザインを忠実に再現します。SASSを用いて、効率的でメンテナンス性の高いコーディングを致します。</p>
        </section>
    ...
    </section><!-- p-service__content(コーディング) -->
